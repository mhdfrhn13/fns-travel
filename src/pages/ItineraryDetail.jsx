...
const ItineraryDetail = () => {
  ...
  return (
    <div className="bg-white pb-20">
      {/* HEADER BANNER */}
      {/* PERBAIKAN 1: Ubah h-[50vh] menjadi h-[60vh] agar banner lebih lega */}
      <header
      ...
      >
        ...
        {/* Konten Teks Banner */}
        {/* PERBAIKAN 2: Ubah pb-10 menjadi pb-32. 
            Ini memaksa teks naik jauh ke atas, menjauh dari kartu putih */}
      ...
      {/* MAIN CONTENT (KARTU PUTIH) */}
      {/* PERBAIKAN 3: Gunakan -mt-20 agar kartu naik lebih tegas menutupi bawah banner */}
      <main className="max-w-[1100px] mx-auto px-4 -mt-20 relative z-20">
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden min-h-[500px]">
          ...
          <div className="p-6 md:p-10">
            {/* ... Paste kode isi tab summary & itinerary di sini ... */}
            {activeTab === "summary" && (
